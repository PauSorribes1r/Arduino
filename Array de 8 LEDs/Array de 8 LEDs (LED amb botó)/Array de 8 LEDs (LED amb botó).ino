...
void loop()
{
  ...
  digitalWrite(led3, HIGH);    // posar a 5V el pin 7
  
  digitalWrite(led5, HIGH);    // posar a 5V el pin 9
  
  digitalWrite(led7, HIGH);    // posar a 5V el pin 11
  ...
  digitalWrite(led7, HIGH);    // posar a 5V el pin 7

  delay(temps);                  // es queden leds tempsms encesos
  
  digitalWrite(led0, LOW);     // posar a 0V el pin 5
  
  digitalWrite(led7, LOW);     // posar a 0V el pin 7
  ...
  digitalWrite(led6, HIGH);    // posar a 5V el pin 9
  
  digitalWrite(led7, HIGH);    // posar a 5V el pin 11
  
  delay(temps);

  digitalWrite(led1, LOW);    // posar a 5V el pin 5
  
  digitalWrite(led0, LOW);    // posar a 5V el pin 7
  
  digitalWrite(led6, LOW);    // posar a 5V el pin 9
  ...
  digitalWrite(led6, HIGH);     // posar a 0V el pin 9
  
  digitalWrite(led5, HIGH);     // posar a 0V el pin 11
  ...
  digitalWrite(led6, LOW);     // posar a 0V el pin 9
  
  digitalWrite(led5, LOW);     // posar a 0V el pin 11
